...
export default class ProductsSizeController {
    ...
    productsSizeService;
    stockItemService;
    constructor(productsSizeService, stockItemService) {
    ...
    setProduct = async (req, res) => {
        ...
        let { shop_products_id, param_one, param_two, param_three, width, number, weight, section_id, price } = req.body;
        ...
        if (Object.values(required).some(value => value === undefined || value === null) ||
        ...
        try {
            ...
            const stockItemArray = await this.stockItemService.setMultiStockItem(stockItemData, number);
